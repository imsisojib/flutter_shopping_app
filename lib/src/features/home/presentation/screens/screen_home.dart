...
class _ScreenHomeState extends State<ScreenHome> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((callback) {
      context.read<ProviderProductSale>().fetchAllProductSale();
      super.initState();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<ProviderProductSale>(builder: (context, provider, child) {
        final productsSale = provider.productSale;
        return SafeArea(
